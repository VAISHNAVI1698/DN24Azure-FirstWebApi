...
{  const [data,setData]=useState([]);
  ...
  <h1 className="text-center mb-4  margin-mt-5 pt-5" style={{width: "100%" , color: "#FF5722"}}>COURSE OVERVIEW </h1>
   ...
   <Button variant="warning" size="200px" className='btn-lg' style={{ width: "15%"  }} onClick={ ()=>openInNewTab('https://www.w3schools.com/java/')}>Java</Button>
    ...
    <div className="mt-5"><center>
    <Button variant="success" className='btn-lg' style={{ width: "15%"  }} onClick={  ()=>window.location='./TraineeHome'}>Back</Button>
    </center></div>
