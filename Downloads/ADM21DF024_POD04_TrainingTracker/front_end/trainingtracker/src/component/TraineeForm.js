    ...
    <>
      <Form className="m-auto mt-5" style={{ width: "40%" }}>
        ...
        <Form.Group as={Row} className="mb-3" controlId="formfirstName">
          ...
          <h5>   <b className="text-black">First Name</b> </h5>
          </Form.Label>
          <Col sm="7">
            <Form.Control
              type="text"
        ...
        <Form.Group as={Row} className="mb-3" controlId="formsecondName">
          <Form.Label column sm="5">
          <h5>   <b className="text-black">Second Name</b> </h5>
          </Form.Label>
          <Col sm="7">
            <Form.Control
              type="text"
        ...
        <Form.Group as={Row} className="mb-3" controlId="dob">
          <Form.Label column sm="5">
          <h5>  <b className="text-black">Date Of Birth</b> </h5>
          </Form.Label>
          <Col sm="7">
            <Form.Control
              type="date"
        ...
        <Form.Group as={Row} className="mb-3" controlId="pass">
          <Form.Label column sm="5">
          <h5>    <b className="text-black">Password</b> </h5>
          </Form.Label>
          <Col sm="7">
            <Form.Control
              type="password"
        ...
        <Form.Group as={Row} className="mb-3" controlId="confirmpass">
          <Form.Label column sm="5">
          <h5>  <b className="text-black">Confirm Password</b> </h5>
          </Form.Label>
          <Col sm="7">
            <Form.Control
              type="password"
        ...
        <Form.Label column sm="5">
          <h5>  <b className="text-black">Address:</b> </h5>
          </Form.Label>
